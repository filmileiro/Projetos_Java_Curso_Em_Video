...
public class NotasAlnos {
	...
	public static void main(String[] args) {
		...
		if (semestre1.n1 > 10 || semestre1.n1 < 0) {
		 System.out.println("ENTRE COM UMA NOTA DE 0.0 ATÉ 10.0 : ");
		 semestre1.n1 = sc.nextDouble();	
		}
		semestre1.n2 = sc.nextDouble();
		if (semestre1.n2 > 10 || semestre1.n2 < 0) {
			 System.out.println("ENTRE COM UMA NOTA DE 0.0 ATÉ 10.0 : ");
			 semestre1.n2 = sc.nextDouble();	
		}
		semestre1.n3 = sc.nextDouble();
		if (semestre1.n3 > 10 || semestre1.n3 < 0) {
			 System.out.println("ENTRE COM UMA NOTA DE 0.0 ATÉ 10.0 : ");
			 semestre1.n3 = sc.nextDouble();	
		}

		System.out.println();
		System.out.println("Semestre 2º:  ");
		
		semestre2.n1 = sc.nextDouble();
		if (semestre2.n1 > 10 || semestre2.n1 < 0) {
			 System.out.println("ENTRE COM UMA NOTA DE 0.0 ATÉ 10.0 : ");
			 semestre2.n1 = sc.nextDouble();	
		}
		semestre2.n2 = sc.nextDouble();
		if (semestre2.n2 > 10 || semestre2.n2 < 0) {
			 System.out.println("ENTRE COM UMA NOTA DE 0.0 ATÉ 10.0 : ");
			 semestre2.n2 = sc.nextDouble();	
		}
		semestre2.n3 = sc.nextDouble();	
		if (semestre2.n3 > 10 || semestre2.n3 < 0) {
			 System.out.println("ENTRE COM UMA NOTA DE 0.0 ATÉ 10.0 : ");
			 semestre2.n3 = sc.nextDouble();	
		}
